"""
Django settings for gentle_base_5 project.
...
ROOT_URLCONF = 'gentle_base_5.urls'
...
WSGI_APPLICATION = 'gentle_base_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Gentle Base Support <support@gentle-base-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_base_5 API",
    "DESCRIPTION": "API documentation for gentle_base_5 App",
    "VERSION": "v1",
}
